...
\captionof{figure}{\label{Pow}Performance-Power consumption ratio for each CPU.}
\end{Figure}
...
\captionof{figure}{\label{Ratio}Performance-Power consumotion ration for each codelets.}
\end{Figure}
...
\captionof{figure}{\label{Freq_instr}Repartition of the instructions during the execution of the Freqmine codelet.}
\end{Figure}
...
\captionof{figure}{\label{Blasch_instr}Repartition of the instructions during the execution of the Blackscholes codelet.}
\end{Figure}
