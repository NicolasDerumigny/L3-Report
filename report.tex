...
This CPU aside, the classic X86 ones do not show some great relative differences, except on freqmine, where the Q9100 is a bit better than the other due to its larger L2 cache. We show here the uselessness of large cache size when working on small data. Therefore, blackscholes seems to limit the advance of the Cortex-A15: the small associativity of L1D and L1I probably limits it on floating operations.
